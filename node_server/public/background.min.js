...
if (function(t, e) {
    ...
    function l(t, e, n) {
        ...
        if (void 0 === n && 1 === t.nodeType)
            if (i = "data-" + e.replace(kt, "-$&").toLowerCase(),
    ...
    function c(t, e, n, i) {
        ...
        , l = a(), c = n && n[3] || (ot.cssNumber[e] ? "" : "px"), u = (ot.cssNumber[e] || "px" !== c && +l) && St.exec(ot.css(t, e));
        if (u && u[3] !== c) {
            c = c || u[3],
            n = n || [],
            u = +l || 1;
    ...
    function T(t, e, n, i) {
        e = G.apply([], e);
        var r, o, s, a, l, c, p = 0, f = t.length, h = f - 1, v = e[0], m = ot.isFunction(v);
        if (m || f > 1 && "string" == typeof v && !it.checkClone && Pt.test(v))
            return t.each(function(r) {
                var o = t.eq(r);
                m && (e[0] = v.call(this, r, o.html())),
                T(o, e, n, i)
            });
        if (f && (r = d(e, t[0].ownerDocument, !1, t, i),
        o = r.firstChild,
        1 === r.childNodes.length && (r = o),
        o || i)) {
            for (s = ot.map(u(r, "script"), y),
            a = s.length; f > p; p++)
                l = r,
                p !== h && (l = ot.clone(l, !0, !0),
                a && ot.merge(s, u(l, "script"))),
                n.call(t[p], l, p);
            if (a)
                ...
                p = 0; a > p; p++)
                    l = s[p],
                    Nt.test(l.type || "") && !wt.access(l, "globalEval") && ot.contains(c, l) && (l.src ? ot._evalUrl && ot._evalUrl(l.src) : ot.globalEval(l.textContent.replace(Mt, "")))
        }
        return t
    }
    function C(t, e, n) {
        for (var i, r = e ? ot.filter(e, t) : t, o = 0; null != (i = r[o]); o++)
            ...
            i.parentNode && (n && ot.contains(i.ownerDocument, i) && p(u(i, "script")),
    ...
    function E(t) {
        var e = Q
          , n = Wt[t];
        return n || (n = k(t, e),
        "none" !== n && n || (Ht = (Ht || ot("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
    ...
    function S(t, e, n) {
        ...
        !it.pixelMarginRight() && Bt.test(s) && zt.test(e) && (i = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    function D(t, e, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > o; o += 2)
            "margin" === n && (s += ot.css(t, n + _t[o], !0, r)),
            i ? ("content" === n && (s -= ot.css(t, "padding" + _t[o], !0, r)),
            "margin" !== n && (s -= ot.css(t, "border" + _t[o] + "Width", !0, r))) : (s += ot.css(t, "padding" + _t[o], !0, r),
            "padding" !== n && (s += ot.css(t, "border" + _t[o] + "Width", !0, r)));
        return s
    }
    function N(e, n, i) {
        var r = !0
    ...
    function j(t, e) {
        for (var n, i, r, o = [], s = 0, a = t.length; a > s; s++)
            i = t[s],
            i.style && (o[s] = wt.get(i, "olddisplay"),
            n = i.style.display,
            e ? (o[s] || "none" !== n || (i.style.display = ""),
            "" === i.style.display && At(i) && (o[s] = wt.access(i, "olddisplay", E(i.nodeName)))) : (r = At(i),
            "none" === n && r || wt.set(i, "olddisplay", r ? n : ot.css(i, "display"))));
        for (s = 0; a > s; s++)
            i = t[s],
    ...
    function q(t, e, n) {
        var i, r, o, s, a, l, c, u = this, p = {}, d = t.style, f = t.nodeType && At(t), h = wt.get(t, "fxshow");
        ...
        c = ot.css(t, "display"),
        "inline" === ("none" === c ? wt.get(t, "olddisplay") || E(t.nodeName) : c) && "none" === ot.css(t, "float") && (d.display = "inline-block")),
        ...
        if (ot.isEmptyObject(p))
            "inline" === ("none" === c ? E(t.nodeName) : c) && (d.display = c);
        else {
            h ? "hidden"in h && (f = h.hidden) : h = wt.access(t, "fxshow", {}),
            o && (h.hidden = !f),
    ...
    function F(t, e, n) {
        var i, r, o = 0, s = F.prefilters.length, a = ot.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var e = Zt || O(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, o = 1 - i, s = 0, l = c.tweens.length; l > s; s++)
                c.tweens[s].run(o);
            return a.notifyWith(t, [c, o, n]),
            1 > o && l ? n : (a.resolveWith(t, [c]),
            !1)
        }, c = a.promise({
            elem: t,
            props: ot.extend({}, e),
        ...
        for (P(u, c.opts.specialEasing); s > o; o++)
            if (i = F.prefilters[o].call(c, t, u, c.opts))
                return ot.isFunction(i.stop) && (ot._queueHooks(c.elem, c.opts.queue).stop = ot.proxy(i.stop, i)),
                i;
        return ot.map(u, L, c),
    ...
    function H(t) {
        return function(e, n) {
            "string" != typeof e && (n = e,
            e = "*");
            var i, r = 0, o = e.toLowerCase().match(gt) || [];
            if (ot.isFunction(n))
                for (; i = o[r++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
        ...
        a--); l > a; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    n = s[e],
                    i = t[e],
                    s !== i && (c && i && (ot.isPlainObject(i) || (r = ot.isArray(i))) ? (r ? (r = !1,
                    o = n && ot.isArray(n) ? n : []) : o = n && ot.isPlainObject(n) ? n : {},
                    s[e] = ot.extend(c, o, i)) : void 0 !== i && (s[e] = i));
        return s
    }
    ,
    ot.extend({
        ...
        globalEval: function(t) {
            var e, n = eval;
            (t = ot.trim(t)) && (1 === t.indexOf("use strict") ? (e = Q.createElement("script"),
            e.text = t,
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (n(Object(t)) ? ot.merge(i, "string" == typeof t ? [t] : t) : K.call(i, t)),
            i
        },
        ...
        proxy: function(t, e) {
            ...
            e = t,
            t = n),
            ot.isFunction(t) ? (i = Y.call(arguments, 2),
            r = function() {
    ...
    "function" == typeof Symbol && (ot.fn[Symbol.iterator] = J[Symbol.iterator]),
    ot.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function(t, e) {
        tt["[object " + e + "]"] = e.toLowerCase()
    });
    var at = function(t) {
        function e(t, e, n, i) {
            var r, o, s, a, c, p, d, f, h = e && e.ownerDocument, v = e ? e.nodeType : 9;
            if (n = n || [],
            "string" != typeof t || !t || 1 !== v && 9 !== v && 11 !== v)
                return n;
            if (!i && ((e ? e.ownerDocument || e : P) !== D && $(e),
            e = e || D,
            j)) {
                if (11 !== v && (p = vt.exec(t)))
                    if (r = p[1]) {
                        if (9 === v) {
                            ...
                            if (s.id === r)
                                return n.push(s),
                                n
                        } else if (h && (s = h.getElementById(r)) && L(e, s) && s.id === r)
                            return n.push(s),
                            n
                    } else {
                        if (p[2])
                            ...
                            n;
                        if ((r = p[3]) && b.getElementsByClassName && e.getElementsByClassName)
                            return Y.apply(n, e.getElementsByClassName(r)),
                            n
                    }
                if (b.qsa && !z[t + " "] && (!I || !I.test(t))) {
                    if (1 !== v)
                        ...
                        for ((a = e.getAttribute("id")) ? a = a.replace(gt, "\\$&") : e.setAttribute("id", a = q),
                        d = C(t),
                        o = d.length,
        ...
        function v(t, e, n, r, o, s) {
            ...
            o && !o[q] && (o = v(o, s)),
            i(function(i, s, a, l) {
                var c, u, p, d = [], v = [], m = s.length, g = i || f(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? g : h(g, d, t, a, l), b = n ? o || (i ? t : m || r) ? [] : s : y;
                if (n && n(y, b, a, l),
                r)
                    for (c = h(b, v),
                    r(c, [], a, l),
                ...
                if (i) {
                    if (o || t) {
                        ...
                        for (u = b.length; u--; )
                            (p = b[u]) && (c = o ? K(i, p) : d[u]) > -1 && (i[c] = !(s[c] = p))
                    }
                } else
                    b = h(b === s ? b.splice(m, b.length) : b),
        ...
        function g(t, n) {
            var r = n.length > 0
              ...
              , s = function(i, s, a, l, c) {
                var u, p, d, f = 0, v = "0", m = i && [], g = [], y = S, b = i || o && x.find.TAG("*", c), w = F += null == y ? 1 : Math.random() || .1, T = b.length;
                for (c && (S = s === D || s || c); v !== T && null != (u = b[v]); v++) {
                    if (o && u) {
                        for (p = 0,
                        s || u.ownerDocument === D || ($(u),
                        a = !j); d = t[p++]; )
                            if (d(u, s || D, a)) {
                                l.push(u);
                                break
        ...
        var y, b, x, w, T, C, k, E, S, _, A, $, D, N, j, I, O, R, L, q = "sizzle" + 1 * new Date, P = t.document, F = 0, M = 0, H = n(), W = n(), z = n(), B = function(t, e) {
            return t === e && (A = !0),
            0
        }, U = 1 << 31, X = {}.hasOwnProperty, V = [], J = V.pop, Q = V.push, Y = V.push, G = V.slice, K = function(t, e) {
            for (var n = 0, i = t.length; i > n; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, Z = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", tt = "[\\x20\\t\\r\\n\\f]", et = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", nt = "\\[" + tt + "*(" + et + ")(?:" + tt + "*([*^$|!~]?=)" + tt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + et + "))|)" + tt + "*\\]", it = ":(" + et + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + nt + ")*)|.*)\\)|)", rt = new RegExp(tt + "+","g"), ot = new RegExp("^" + tt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + tt + "+$","g"), st = new RegExp("^" + tt + "*," + tt + "*"), at = new RegExp("^" + tt + "*([>+~]|" + tt + ")" + tt + "*"), lt = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]","g"), ct = new RegExp(it), ut = new RegExp("^" + et + "$"), pt = {
            ID: new RegExp("^#(" + et + ")"),
            CLASS: new RegExp("^\\.(" + et + ")"),
            TAG: new RegExp("^(" + et + "|[*])"),
            ATTR: new RegExp("^" + nt),
        ...
        }, dt = /^(?:input|select|textarea|button)$/i, ft = /^h\d$/i, ht = /^[^{]+\{\s*\[native \w/, vt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, mt = /[+~]/, gt = /'|\\/g, yt = new RegExp("\\\\([\\da-f]{1,6}" + tt + "?|(" + tt + ")|.)","ig"), bt = function(t, e, n) {
            var i = "0x" + e - 65536;
        ...
        try {
            Y.apply(V = G.call(P.childNodes), P.childNodes),
        ...
        $ = e.setDocument = function(t) {
            ...
            N = D.documentElement,
            j = !T(D),
            (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xt, !1) : n.attachEvent && n.attachEvent("onunload", xt)),
            ...
            b.getElementsByClassName = ht.test(D.getElementsByClassName),
            b.getById = r(function(t) {
                return N.appendChild(t).id = q,
            ...
            O = [],
            I = [],
            (b.qsa = ht.test(D.querySelectorAll)) && (r(function(t) {
            ...
            (b.matchesSelector = ht.test(R = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && r(function(t) {
                b.disconnectedMatch = R.call(t, "div"),
                R.call(t, "[s!='']:x"),
                O.push("!=", it)
            }),
            ...
            L = e || ht.test(N.contains) ? function(t, e) {
            ...
            B = e ? function(t, e) {
                ...
                1 & n || !b.sortDetached && e.compareDocumentPosition(t) === n ? t === D || t.ownerDocument === P && L(P, t) ? -1 : e === D || e.ownerDocument === P && L(P, e) ? 1 : _ ? K(_, t) - K(_, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return A = !0,
                ...
                if (!r || !o)
                    return t === D ? -1 : e === D ? 1 : r ? -1 : o ? 1 : _ ? K(_, t) - K(_, e) : 0;
                if (r === o)
                    return s(t, e);
        ...
        e.matchesSelector = function(t, n) {
            if ((t.ownerDocument || t) !== D && $(t),
            n = n.replace(lt, "='$1']"),
            b.matchesSelector && j && !z[n + " "] && (!O || !O.test(n)) && (!I || !I.test(n)))
                try {
                    var i = R.call(t, n);
        ...
        x = e.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return pt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && ct.test(n) && (e = C(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, n, i, r) {
                    ...
                    : function(e, n, l) {
                        var c, u, p, d, f, h, v = o !== s ? "nextSibling" : "previousSibling", m = e.parentNode, g = a && e.nodeName.toLowerCase(), y = !l && !a, b = !1;
                        if (m) {
                            if (o) {
                                for (; v; ) {
                                    for (d = e; d = d[v]; )
                            ...
                            s && y) {
                                ...
                                f = c[0] === F && c[1],
                                b = f && c[2],
                                d = f && m.childNodes[f]; d = ++f && d && d[v] || (b = f = 0) || h.pop(); )
                            ...
                            b = f),
                            b === !1)
                                for (; (d = ++f && d && d[v] || (b = f = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== g : 1 !== d.nodeType) || !++b || (y && (p = d[q] || (d[q] = {}),
                                u = p[d.uniqueID] || (p[d.uniqueID] = {}),
                                u[t] = [F, b]),
                                d !== e)); )
                                    ;
        ...
        E = e.select = function(t, e, n, i) {
            var r, o, s, a, c, p = "function" == typeof t && t, d = !i && C(t = p.selector || t);
            if (n = n || [],
            1 === d.length) {
                if (o = d[0] = d[0].slice(0),
                o.length > 2 && "ID" === (s = o[0]).type && b.getById && 9 === e.nodeType && j && x.relative[o[1].type]) {
                    if (!(e = (x.find.ID(s.matches[0].replace(yt, bt), e) || [])[0]))
                        return n;
                    p && (e = e.parentNode),
            ...
            return (p || k(t, d))(i, e, !j, n, !e || mt.test(t) && l(e.parentNode) || e),
            n
        }
        ,
        b.sortStable = q.split("").sort(B).join("") === q,
    ...
    ot.find = at,
    ot.expr = at.selectors,
    ot.expr[":"] = ot.expr.pseudos,
    ot.uniqueSort = ot.unique = at.uniqueSort,
    ot.text = at.getText,
    ot.isXMLDoc = at.isXML,
    ot.contains = at.contains;
    ...
    (ot.fn.init = function(t, e, n) {
        ...
        if (n = n || ft,
        "string" == typeof t) {
            if (!(i = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : ht.exec(t)) || !i[1] && e)
    ...
    ot.each({
        ...
        ot.fn[t] = function(n, i) {
            ...
            this.length > 1 && (mt[t] || ot.uniqueSort(r),
            vt.test(t) && r.reverse()),
            this.pushStack(r)
        }
    });
    ...
    ot.extend({
        ...
        when: function(t) {
            var e, n, i, r = 0, o = Y.call(arguments), s = o.length, a = 1 !== s || t && ot.isFunction(t.promise) ? s : 0, l = 1 === a ? t : ot.Deferred(), c = function(t, n, i) {
                return function(r) {
                    n[t] = this,
                    i[t] = arguments.length > 1 ? Y.call(arguments) : r,
            ...
            if (s > 1)
                ...
                n = new Array(s),
                i = new Array(s); s > r; r++)
                    o[r] && ot.isFunction(o[r].promise) ? o[r].promise().progress(c(r, n, e)).done(c(r, i, o)).fail(l.reject) : --a;
    ...
    ot.extend({
        ...
        ready: function(t) {
            ...
            t !== !0 && --ot.readyWait > 0 || (yt.resolveWith(Q, [ot]),
            ot.fn.triggerHandler && (ot(Q).triggerHandler("ready"),
            ot(Q).off("ready"))))
        }
    }),
    ot.ready.promise = function(e) {
        return yt || (yt = ot.Deferred(),
    ...
    ot.fn.extend({
        data: function(t, e) {
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                var n, i;
                if (o && void 0 === e) {
                    if (void 0 !== (n = Tt.get(o, t) || Tt.get(o, t.replace(kt, "-$&").toLowerCase())))
                        return n;
                    if (i = ot.camelCase(t),
                    void 0 !== (n = Tt.get(o, i)))
                        return n;
    ...
    ot.extend({
        queue: function(t, e, n) {
            ...
            i = wt.get(t, e),
            n && (!i || ot.isArray(n) ? i = wt.access(t, e, ot.makeArray(n)) : i.push(n)),
            i || []) : void 0
        },
    ...
    ot.fn.extend({
        ...
        promise: function(t, e) {
            ...
            t = void 0),
            t = t || "fx"; s--; )
                (n = wt.get(o[s], t + "queueHooks")) && n.empty && (i++,
                n.empty.add(a));
            return a(),
            r.promise(e)
        }
    ...
    ot.event = {
        ...
        add: function(t, e, n, i, r) {
            ...
            if (m)
                ...
                c = e.length; c--; )
                    ...
                    (d = l[f]) || (d = l[f] = [],
                    d.delegateCount = 0,
                    p.setup && p.setup.call(t, i, h, s) !== !1 || t.addEventListener && t.addEventListener(f, s)),
            ...
            if (m && (l = m.events)) {
                ...
                c = e.length; c--; )
                    ...
                    f) {
                        ...
                        s && !d.length && (p.teardown && p.teardown.call(t, h, m.handle) !== !1 || ot.removeEvent(t, f, m.handle),
                        delete l[f])
                    } else
                        for (f in l)
        ...
        dispatch: function(t) {
            t = ot.event.fix(t);
            var e, n, i, r, o, s = [], a = Y.call(arguments), l = (wt.get(this, "events") || {})[t.type] || [], c = ot.event.special[t.type] || {};
            if (a[0] = t,
            ...
            !c.preDispatch || c.preDispatch.call(this, t) !== !1) {
                ...
                e = 0; (r = s[e++]) && !t.isPropagationStopped(); )
                    ...
                    n = 0; (o = r.handlers[n++]) && !t.isImmediatePropagationStopped(); )
                        ...
                        t.data = o.data,
                        void 0 !== (i = ((ot.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, a)) && (t.result = i) === !1 && (t.preventDefault(),
                        t.stopPropagation()));
        ...
        fix: function(t) {
            ...
            for (s || (this.fixHooks[r] = s = Rt.test(r) ? this.mouseHooks : Ot.test(r) ? this.keyHooks : {}),
    ...
    ot.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? f : h) : this.type = t,
        e && ot.extend(this, e),
    ...
    var Ht, Wt = {
        HTML: "block",
        BODY: "block"
    }, zt = /^margin/, Bt = new RegExp("^(" + Et + ")(?!px)[a-z%]+$","i"), Ut = function(e) {
    ...
    ot.each(["height", "width"], function(t, e) {
        ot.cssHooks[e] = {
            ...
            set: function(t, n, i) {
                var r, o = i && Ut(t), s = i && D(t, e, i, "border-box" === ot.css(t, "boxSizing", !1, o), o);
                return s && (r = St.exec(n)) && "px" !== (r[3] || "px") && (t.style[e] = n,
                n = ot.css(t, e)),
                $(t, n, s)
            }
        }
    ...
    ot.fx = I.prototype.init,
    ot.fx.step = {};
    var Zt, te, ee = /^(?:toggle|show|hide)$/, ne = /queueHooks$/;
    ot.Animation = ot.extend(F, {
        tweeners: {
            "*": [function(t, e) {
                var n = this.createTween(t, e);
                return c(n.elem, t, St.exec(e), n),
                n
            }
            ]
        },
    ...
    ot.fn.extend({
        ...
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
            this.each(function() {
                var e, n = wt.get(this), i = n[t + "queue"], r = n[t + "queueHooks"], o = ot.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                ot.queue(this, t, []),
    ...
    ot.extend({
        attr: function(t, e, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                ...
                r = ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? ie : void 0)),
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ot.isFunction(t) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    (void 0 === t || "boolean" === n) && (e = M(this),
                    e && wt.set(this, "__className__", e),
                    this.setAttribute && this.setAttribute("class", e || t === !1 ? "" : wt.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++]; )
                if (1 === n.nodeType && (" " + M(n) + " ").replace(ae, " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    });
    ...
    ot.extend(ot.event, {
        trigger: function(e, n, i, r) {
            var o, s, a, l, c, u, p, d = [i || Q], f = nt.call(e, "type") ? e.type : e, h = nt.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = a = i = i || Q,
            3 !== i.nodeType && 8 !== i.nodeType && !le.test(f + ot.event.triggered) && (f.indexOf(".") > -1 && (h = f.split("."),
            f = h.shift(),
            h.sort()),
            c = f.indexOf(":") < 0 && "on" + f,
            ...
            r || !p.trigger || p.trigger.apply(i, n) !== !1)) {
                ...
                for (o = 0; (s = d[o++]) && !e.isPropagationStopped(); )
                    ...
                    u = (wt.get(s, "events") || {})[e.type] && wt.get(s, "handle"),
                    u && u.apply(s, n),
                    (u = c && s[c]) && u.apply && xt(s) && (e.result = u.apply(s, n),
                    e.result === !1 && e.preventDefault());
                return e.type = f,
                r || e.isDefaultPrevented() || p._default && p._default.apply(d.pop(), n) !== !1 || !xt(i) || c && ot.isFunction(i[f]) && !ot.isWindow(i) && (a = i[c],
                a && (i[c] = null),
    ...
    it.focusin || ot.each({
        ...
        ot.event.special[e] = {
            ...
            teardown: function() {
                var i = this.ownerDocument || this
                  , r = wt.access(i, e) - 1;
                r ? wt.access(i, e, r) : (i.removeEventListener(t, n, !0),
                wt.remove(i, e))
            }
        }
    });
    ...
    ot.extend({
        ...
        ajax: function(e, n) {
            function i(e, n, i, a) {
                ...
                i && (b = B(d, T, i)),
                b = U(d, b, T, c),
                c ? (d.ifModified && (w = T.getResponseHeader("Last-Modified"),
                w && (ot.lastModified[o] = w),
                (w = T.getResponseHeader("etag")) && (ot.etag[o] = w)),
                ...
                T.status = e,
                T.statusText = (n || C) + "",
                c ? v.resolveWith(f, [p, C, T]) : v.rejectWith(f, [T, C, y]),
                T.statusCode(g),
                g = void 0,
                u && h.trigger(c ? "ajaxSuccess" : "ajaxError", [T, d, c ? p : y]),
                m.fireWith(f, [T, C]),
            ...
            e = void 0),
            n = n || {};
            var r, o, s, a, l, c, u, p, d = ot.ajaxSetup({}, n), f = d.context || d, h = d.context && (f.nodeType || f.jquery) ? ot(f) : ot.event, v = ot.Deferred(), m = ot.Callbacks("once memory"), g = d.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", T = {
                readyState: 0,
            ...
            T.success = T.done,
            T.error = T.fail,
            d.url = ((e || d.url || ce.href) + "").replace(/#.*$/, "").replace(/^\/\//, ce.protocol + "//"),
            d.type = n.method || n.type || d.method || d.type,
            d.dataTypes = ot.trim(d.dataType || "*").toLowerCase().match(gt) || [""],
            null == d.crossDomain) {
                c = Q.createElement("a");
                try {
                    c.href = d.url,
            ...
            o = d.url,
            d.hasContent || (d.data && (o = d.url += (pe.test(o) ? "&" : "?") + d.data,
            delete d.data),
            d.cache === !1 && (d.url = de.test(o) ? o.replace(de, "$1_=" + ue++) : o + (pe.test(o) ? "&" : "?") + "_=" + ue++)),
            d.ifModified && (ot.lastModified[o] && T.setRequestHeader("If-Modified-Since", ot.lastModified[o]),
            ...
            T.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + ye + "; q=0.01" : "") : d.accepts["*"]);
            for (p in d.headers)
            ...
            send: function(r, o) {
                ...
                n = function(t) {
                    return function() {
                        ...
                        "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Ce[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    ot.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        a ? e[a] = e[a].replace(Se, "$1" + r) : e.jsonp !== !1 && (e.url += (pe.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
    ...
    ot.offset = {
        setOffset: function(t, e, n) {
            var i, r, o, s, a, l, c, u = ot.css(t, "position"), p = ot(t), d = {};
    ...
    ot.fn.extend({
        ...
        position: function() {
            if (this[0]) {
                ...
                i.top += ot.css(t[0], "borderTopWidth", !0) - t.scrollTop(),
                i.left += ot.css(t[0], "borderLeftWidth", !0) - t.scrollLeft()),
                {
    ...
    ot.each(["top", "left"], function(t, e) {
        ot.cssHooks[e] = _(it.pixelPosition, function(t, n) {
            return n ? (n = S(t, e),
            Bt.test(n) ? ot(t).position()[e] + "px" : n) : void 0
        })
    }),
    ot.each({
        Height: "height",
    ...
    n.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (c) {
                ...
                a = "bottom" == a && u.bottom + d > h.bottom ? "top" : "top" == a && u.top - d < h.top ? "bottom" : "right" == a && u.right + p > h.width ? "left" : "left" == a && u.left - p < h.left ? "right" : a,
...
function(t) {
    ...
    n.prototype.getState = function(t, e, n, i) {
        ...
        if ("bottom" == this.affixed)
            return null != n ? !(r + this.unpin <= o.top) && "bottom" : !(t - i >= r + s) && "bottom";
...
var pJS = function(t, e) {
    var n = document.querySelector("#" + t + " > .particles-js-canvas");
    this.pJS = {
        canvas: {
            el: n,
            w: n.offsetWidth,
    ...
    i.fn.particle = function(t, e, n) {
        ...
        i.particles.move.straight ? (this.vx = o.x,
        this.vy = o.y,
    ...
    i.fn.particle.prototype.draw = function() {
        ...
        if (void 0 != t.opacity_bubble)
            ...
            var n = t.opacity;
        if (t.color.rgb)
            var r = "rgba(" + t.color.rgb.r + "," + t.color.rgb.g + "," + t.color.rgb.b + "," + n + ")";
        else
            var r = "hsla(" + t.color.hsl.h + "," + t.color.hsl.s + "%," + t.color.hsl.l + "%," + n + ")";
    ...
    i.fn.particlesUpdate = function() {
        for (var t = 0; t < i.particles.array.length; t++) {
            ...
            switch (e.x - e.radius > i.canvas.w ? (e.x = r.x_left,
            e.y = Math.random() * i.canvas.h) : e.x + e.radius < 0 && (e.x = r.x_right,
            e.y = Math.random() * i.canvas.h),
            e.y - e.radius > i.canvas.h ? (e.y = r.y_top,
            e.x = Math.random() * i.canvas.w) : e.y + e.radius < 0 && (e.y = r.y_bottom,
            ...
            i.particles.line_linked.enable || i.particles.move.attract.enable)
                for (var o = t + 1; o < i.particles.array.length; o++) {
                    ...
                    i.particles.line_linked.enable && i.fn.interact.linkParticles(e, s),
                    i.particles.move.attract.enable && i.fn.interact.attractParticles(e, s),
                    i.particles.move.bounce && i.fn.interact.bounceParticles(e, s)
                }
        }
    }
    ,
    ...
    i.fn.interact.linkParticles = function(t, e) {
        ...
        if (o <= i.particles.line_linked.distance) {
            ...
            if (s > 0) {
                ...
                i.canvas.ctx.strokeStyle = "rgba(" + a.r + "," + a.g + "," + a.b + "," + s + ")",
                i.canvas.ctx.lineWidth = i.particles.line_linked.width,
                i.canvas.ctx.beginPath(),
                i.canvas.ctx.moveTo(t.x, t.y),
    ...
    i.fn.modes.pushParticles = function(t, e) {
        ...
        for (var n = 0; t > n; n++)
            ...
            n == t - 1 && (i.particles.move.enable || i.fn.particlesDraw(),
            i.tmp.pushing = !1)
    }
    ,
    i.fn.modes.removeParticles = function(t) {
        i.particles.array.splice(0, t),
    ...
    i.fn.modes.bubbleParticle = function(t) {
                ...
                if (i.tmp.bubble_duration_end) {
                    if (void 0 != r) {
                        var l = o - p * (o - e) / i.interactivity.modes.bubble.duration
                          , c = e - l;
                        d = e + c,
                        "size" == a && (t.radius_bubble = d),
                        "opacity" == a && (t.opacity_bubble = d)
                    }
        ...
        if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
            ...
            i.tmp.bubble_clicking && (n(i.interactivity.modes.bubble.size, i.particles.size.value, t.radius_bubble, t.radius, "size"),
            n(i.interactivity.modes.bubble.opacity, i.particles.opacity.value, t.opacity_bubble, t.opacity, "opacity"))
        }
    }
    ,
    i.fn.modes.repulseParticle = function(t) {
        if (i.interactivity.events.onhover.enable && isInArray("repulse", i.interactivity.events.onhover.mode) && "mousemove" == i.interactivity.status) {
            ...
            "bounce" == i.particles.move.out_mode ? (l.x - t.radius > 0 && l.x + t.radius < i.canvas.w && (t.x = l.x),
            l.y - t.radius > 0 && l.y + t.radius < i.canvas.h && (t.y = l.y)) : (t.x = l.x,
            t.y = l.y)
            ...
            i.tmp.repulse_clicking) {
                ...
                s >= p && function() {
                    ...
                    "bounce" == i.particles.move.out_mode) {
                        ...
                        n.x + t.radius > i.canvas.w ? t.vx = -t.vx : n.x - t.radius < 0 && (t.vx = -t.vx),
                        n.y + t.radius > i.canvas.h ? t.vy = -t.vy : n.y - t.radius < 0 && (t.vy = -t.vy)
                    }
                }()
            } else
                0 == i.tmp.repulse_clicking && (t.vx = t.vx_i,
                t.vy = t.vy_i)
    }
    ,
        ...
        if (i.interactivity.events.onhover.enable && "mousemove" == i.interactivity.status) {
            ...
            if (r <= i.interactivity.modes.grab.distance) {
                ...
                if (o > 0) {
                    ...
                    i.canvas.ctx.strokeStyle = "rgba(" + s.r + "," + s.g + "," + s.b + "," + o + ")",
                    i.canvas.ctx.lineWidth = i.particles.line_linked.width,
                    i.canvas.ctx.beginPath(),
                    i.canvas.ctx.moveTo(t.x, t.y),
    ...
    i.fn.vendors.eventsListeners = function() {
        ...
        (i.interactivity.events.onhover.enable || i.interactivity.events.onclick.enable) && (i.interactivity.el.addEventListener("mousemove", function(t) {
    ...
    i.fn.vendors.checkOverlap = function(t, e) {
        for (var n = 0; n < i.particles.array.length; n++) {
            var r = i.particles.array[n]
              , o = t.x - r.x
              , s = t.y - r.y;
            Math.sqrt(o * o + s * s) <= t.radius + r.radius && (t.x = e ? e.x : Math.random() * i.canvas.w,
            t.y = e ? e.y : Math.random() * i.canvas.h,
            i.fn.vendors.checkOverlap(t))
        }
    }
    ,
        ...
        "" != i.particles.shape.image.src)
            if ("svg" == t) {
                ...
                e.onreadystatechange = function(t) {
                    4 == e.readyState && (200 == e.status ? (i.tmp.source_svg = t.currentTarget.response,
...
window.particlesJS = function(t, e) {
    ...
    o.style.width = "100%",
    o.style.height = "100%",
    null != document.getElementById(t).appendChild(o) && pJSDom.push(new pJS(t,e))
}
,
...
$(document).ready(function() {
    ...
    particlesJS.load("particles-js-inline", "/particlesinline.json", function() {})
});
